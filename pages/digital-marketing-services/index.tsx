...
const index = () => {
  return (
    <div>
      <Head>
        <title>Digital Marketing Services / Lead</title>
        <meta
          name="description"
          content="Digital Marketing Services: Lead"
        />
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
        <meta property="og:title" content="Digital Marketing Services: Lead" />
        <meta property="og:description" content="Digital Marketing Services: Lead" />
        {/* Sitemap */}
      </Head>
