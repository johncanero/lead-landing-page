        ...
        <div className='flex'>
          ...
          <div className='relative'>
            <div className='absolute'>
              <h1 className='max-w-2xl font-medium text-7xl mt-28 font-Montserrat'>A <span className='font-extrabold'>super solution</span> for your <span className='font-extrabold'>business.</span></h1>
